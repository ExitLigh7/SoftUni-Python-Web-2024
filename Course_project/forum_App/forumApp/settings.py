...
SECRET_KEY = 'django-insecure-y4n+a+l8n1@h5p^-)w4q&rl4y^1fvj37!gud(%m-!6ydj0p68+'
...
AUTHENTICATION_BACKENDS = [
    ...
    'django.contrib.auth.backends.ModelBackend', # This is just in case
]
...
# The next 2 rows provide additional security !
