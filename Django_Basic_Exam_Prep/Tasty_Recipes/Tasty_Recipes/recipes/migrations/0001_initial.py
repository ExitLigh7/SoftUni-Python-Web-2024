    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuisine_type', models.CharField(choices=[('FR', 'French'), ('CH', 'Chinese'), ('IT', 'Italian'), ('BA', 'Balkan'), ('OT', 'Other')], max_length=7)),
                ('ingredients', models.TextField(help_text='Ingredients must be separated by a comma and space.')),
                ('instructions', models.TextField()),
                ('cooking_time', models.PositiveSmallIntegerField(help_text='Provide the cooking time in minutes.', validators=[django.core.validators.MinValueValidator(1)])),
